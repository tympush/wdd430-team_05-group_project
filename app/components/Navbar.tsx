          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex gap-3">
              ...
              <button
                ...
                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "var(--color-primary)"; opacity: e.currentTarget.style.opacity = "0.9"; }}
                onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = "var(--color-primary)"; e.currentTarget.style.opacity = "1"; }}
              >
                Sell
              </button>
            </div>
